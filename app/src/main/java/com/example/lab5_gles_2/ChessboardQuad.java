...
public class ChessboardQuad {
    ...
    public ChessboardQuad(Context context, int drawableId) {
        float[] quadCoords = {
                -1.0f, 0.0f, -1.0f,
                -1.0f, 0.0f,  1.0f,
                1.0f, 0.0f,  1.0f,
    ...
    public void draw(float[] viewMatrix, float[] projectionMatrix) {
        ...
        Matrix.translateM(modelMatrix, 0, 0f, -0.3f, 0f); // torusun altına daha yakınlaştır
